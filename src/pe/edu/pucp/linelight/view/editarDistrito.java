 ...
 * @author USER
 */
public class editarDistrito extends javax.swing.JFrame {

    /**
     * Creates new form nuevoDistrito
     */
    public editarDistrito() {
        initComponents();
...
int seleccion = JOptionPane.showOptionDialog(
                    editarDistrito.this, // Componente padre
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editarDistrito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editarDistrito().setVisible(true);
            }
        });
    }
