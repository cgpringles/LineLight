 ...
 * @author USER
 */
public class ViasCargadas extends javax.swing.JFrame {

    /**
     * Creates new form ViasCargadas
     */
    public ViasCargadas() {
        initComponents();
        ...
        public ViasCargadas(int numVias) {
        initComponents();
        Date fecha=new Date();
        SimpleDateFormat sdf=new SimpleDateFormat("dd/MM/yyyy"); 
        txtFecha.setText(sdf.format(fecha));
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
        txtNum.setText(Integer.toString(numVias));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("N° Vías registradas:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViasCargadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViasCargadas().setVisible(true);
            }
        });
    }
